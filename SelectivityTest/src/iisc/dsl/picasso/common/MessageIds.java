...
public class MessageIds {
	...
	public static String[] MessageString = {"", "Get Client Id", "", "", "", "Close Client",
		...
		"Stop Compilation", "Rename Query Template", "Pause Processing", "Resume Processing","Estimated Approximaion Time", "RQEP Create Temp Tables", "RQEP Delete Temp Tables"};
	...
	/* Added by Nila - RQEP */
	public static final int RQEP_CREATE_TEMP_TABLES = 32;
	public static final int RQEP_DELETE_TEMP_TABLES = 33;
