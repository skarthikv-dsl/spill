...
//
//
//public class BinaryTreeLohit {
//
//	Vertex root;
//	BinaryTreeLohit left_child;
//	BinaryTreeLohit right_child;
//	BinaryTreeLohit parent;
//	static HashMap<Integer,Integer> predicateMap = new HashMap<Integer,Integer>(); 
//
//	static String plansPath ;//= "/media/dsladmin/dslssd512gb/Lohit/QT_April_idea/DSQT264DR20_E/";
...
//	//static String path = "/home/dsladmin/Srinivas/data/DSQT264DR20_E/";
...
//
//	public BinaryTreeLohit(){
//
//	}
//	public BinaryTreeLohit(Vertex root, BinaryTreeLohit left_child, BinaryTreeLohit right_child){
//		this.root = root;
...
//		return root;
//	}
//	public BinaryTreeLohit getLeftChild(){
//		return left_child;
//	}
//
//	public BinaryTreeLohit getParent(){
//		return parent;
//	}
//
//	public BinaryTreeLohit getRightChild(){
//		return right_child;
//	}
//
//	public void setLeftChild(BinaryTreeLohit tree){
//		this.left_child = tree;
//		if(tree!=null)
//			tree.parent = this;
//	}
//
//	public void setRightChild(BinaryTreeLohit tree){
...
//	}
//
//	public BinaryTreeLohit getVertexById(int id){
//		if (this.root!=null && this.root.getId()==id){
//			//System.out.print(root.getId() + " ");
//			return this;
//		}
//		else {
//			BinaryTreeLohit  foundVertex =null;
//			if(left_child!=null)
...
//					ltree = new BinaryTreeLohit(new Vertex(child_id,parentMap.get(child_id),tempStr[0].trim(),null), null, null);
//				else
//					ltree = new BinaryTreeLohit(new Vertex(child_id,parentMap.get(child_id),tempStr[0].trim(),tempStr[1].trim()), null, null);
//				if(i==0){
...
//	public boolean isParent(BinaryTreeLohit t1, BinaryTreeLohit t2){
//		//to check whether t1 is a parent of t2
//		BinaryTreeLohit temp = t2;
//		while(temp!=null){
//			if(temp==t1)
//				return true;
//			temp =temp.getParent();
...
//				int spill_node = -1; 
//				int temp = 0;
//				BinaryTreeLohit t_spill = getVertexById(spill_id);
...
//
//		BinaryTreeLohit tree = new BinaryTreeLohit();
//		Properties prop = new Properties();
...
//			String[] tempStr= valueMap.get(0).split(",");
//			if(tempStr[1].contains("null"))
//				tree = new BinaryTreeLohit(new Vertex(0,-1,tempStr[0],null),null,null);
//			else
//				tree = new BinaryTreeLohit(new Vertex(0,-1,tempStr[0],tempStr[1]),null,null);
